  ...
  <header class="topnav">
    <div class="topnav-inner">
      ...
      <nav class="topnav-links">
        <router-link to="/dashboard" class="topnav-link" :class="{ active: route.path === '/dashboard' }">
          Painel
        </router-link>
        <router-link to="/rios" class="topnav-link" :class="{ active: route.path === '/rios' }">
          Rios
        </router-link>
        <router-link to="/usuarios" class="topnav-link" :class="{ active: route.path === '/usuarios' }">
          Usuários
        </router-link>
      </nav>
      ...
      <div class="topnav-actions">
        ...
        <!-- Notification Bell -->
        <button class="topnav-icon-btn" title="Disparar alerta de teste" @click="showEmergency">
