...
class UsuarioSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Usuario
        fields = ['id', 'nome', 'email', 'telefone', 'senha', 'data_criacao', 'data_nascimento', 'is_defesa_civil', 'favoritos']
        read_only_fields = ['id', 'data_criacao', 'favoritos', 'api_token', 'is_defesa_civil']
